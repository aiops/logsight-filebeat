...
//}
//
//func (r *Request) Request(url *url.URL, method string, header map[string]string, body interface{}) (int, *ResponseBody, error) {
//	if body != nil {
//		if err := r.encoder.Marshal(body); err != nil {
//			return -1, nil, fmt.Errorf("failed to encode body (%v): %w", body, err)
//		}
//	}
//
...
//	}
//
//	return r.execHTTPRequest(req, header)
//}
//
